...
import {
  receiveProducts,
  errorReceiveingProducts,
  receiveAddToCart,
  errorReceiveingAddToCart,
  errorReceiveingRemoveFromCart,
  receiveRemoveFromCart,
  errorReceiveingDecrement,
  receiveDecrement
...
export function* decrementQuantity({ payload }) {
  try {
    ...
    cart.cartItems[index].quantity = cart.cartItems[index].quantity - 1;
    cart.cartItems[index].total =
      cart.cartItems[index].total - cart.cartItems[index].price;
